...
jlong Java_com_example_wavify_SttEngine_createFfi(JNIEnv env,
                                                  JClass,
                                                  JString java_model_path,
                                                  JString java_api_key,
                                                  JString java_app_name);

void Java_com_example_wavify_SttEngine_destroyFfi(JNIEnv env, JClass, JString java_model);

jstring Java_com_example_wavify_SttEngine_sttFfi(JNIEnv env,
                                                 JClass,
                                                 JFloatArray data,
                                                 jlong java_model);
